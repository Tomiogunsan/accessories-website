...
const Gallery = () => {
    return(
       <Fragment>
        ...
        <div className='grid md:grid-cols-3 md:grid-rows-none gap-2 md:gap-4  mx-auto max-w-[1240px] h-full'>
        <img className='md:col-span-2 md:row-span-2 w-full h-full object-cover' src={gal} alt='/'/>
